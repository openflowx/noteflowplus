...
export function CreateFlowForm({ onSubmit }: CreateFlowFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit(onFormSubmit)} className="relative group overflow-hidden rounded-3xl bg-white/80 p-5 space-y-6 backdrop-blur-md md:rounded-[2rem] md:p-8 md:space-y-8">
            <div className="absolute top-0 right-0 h-24 w-24 translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-2xl transition-colors group-hover:bg-primary/20" />

            <div className="relative space-y-1 md:space-y-2">
                <h2 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">
                    Create <span className="text-2xl text-primary md:text-3xl">.</span>
                </h2>
            ...
            <div className="relative space-y-5 md:space-y-6">
                <div className="space-y-1.5 md:space-y-2">
                    ...
                    <Input
                        ...
                        className={`h-10 rounded-xl border-slate-100 bg-white shadow-sm transition-all focus:border-primary/40 focus:ring-primary/10 md:h-12 md:rounded-2xl ${errors.title ? "border-red-300 focus:ring-red-100" : ""}`}
                    />
                ...
                <div className="space-y-1.5 md:space-y-2">
                    ...
                    <Textarea
                        ...
                        className="min-h-24 resize-none rounded-xl border-slate-100 bg-white p-3 shadow-sm transition-all focus:border-primary/40 focus:ring-primary/10 md:min-h-28 md:rounded-2xl md:p-4"
                    />
                </div>
                ...
                <div className="space-y-1.5 md:space-y-2">
                    ...
                    <Input
                        ...
                        className={`h-10 rounded-xl border-slate-100 bg-white shadow-sm transition-all focus:border-primary/40 focus:ring-primary/10 md:h-12 md:rounded-2xl ${errors.tags ? "border-red-300 focus:ring-red-100" : ""}`}
                    />
            ...
            <Button
                ...
                className="flex h-11! w-full items-center justify-center gap-3 rounded-full border-0 bg-primary text-sm font-bold text-primary-foreground transition-all hover:scale-[1.02] hover:bg-primary-emphasis active:scale-[0.98] md:h-12! md:text-base"
            >
