    ...
    return (
        ...
        >
            ...
            <div className="space-y-5">
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        placeholder="What is this flow about? (Optional)"
                        className="resize-none min-h-24 bg-gray-50/50"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className={`h-11 ${errors.tags ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                    />
                    <div className="flex justify-between items-center">
                        <p className="text-xs text-gray-500">
                            Separate up to 3 tags with commas
                        </p>
                        {errors.tags && (
                            <p className="text-xs font-medium text-red-500">
                                {errors.tags.message}
            ...
            <Button
                ...
                className="w-full gap-2 font-semibold bg-gray-800 hover:bg-gray-700 text-white shadow-md rounded-full transition-all active:scale-[0.98]"
            >
                {isSubmitting ? (
