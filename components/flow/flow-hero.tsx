...
export function FlowHero() {
    return (
        <div className="relative flex flex-col items-center justify-center overflow-hidden rounded-[2rem] border border-slate-100 bg-white p-6 text-center shadow-xl shadow-sky-50 md:h-full md:rounded-[2.5rem] md:p-8">
            ...
            <div className="mt-8 grid w-full grid-cols-2 gap-3 md:mt-10 md:gap-4">
                <div className="flex flex-col items-center rounded-2xl border border-slate-100 bg-slate-50/50 p-4 md:rounded-3xl md:p-5">
                    <span className="text-2xl font-bold text-sky-500 md:text-3xl">100%</span>
                    <span className="mt-1 text-[9px] font-bold uppercase tracking-widest text-slate-400 md:text-[10px]">Productive</span>
                </div>
                <div className="flex flex-col items-center rounded-2xl border border-slate-100 bg-slate-50/50 p-4 md:rounded-3xl md:p-5">
                    <span className="text-2xl font-bold text-sky-500 md:text-3xl">∞</span>
